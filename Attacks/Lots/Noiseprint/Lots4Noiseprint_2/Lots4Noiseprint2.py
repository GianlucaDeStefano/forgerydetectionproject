...
class LotsNoiseprint2_a(Lots4NoiseprintBase):
    ...
    def __init__(self, objective_image:Picture, objective_mask: np.array, image_path, mask_path, qf: int = None,
        ...
        super().__init__(objective_image, objective_mask, "LOTS4Noiseprint_2", image_path, mask_path, qf, patch_size, steps,
    ...
    def _generate_target_representation(self):
        ...
        image = self.objective_image.to_float().one_channel
        ...
        authentic_patches = original_noiseprint.get_authentic_patches(self.objective_image_mask, self.patch_size, force_shape= True)

        # create target patch object
        target_patch = np.zeros(self.patch_size)

        patches_map = np.zeros(self.objective_image.one_channel.shape)
        ...
        for patch in tqdm(authentic_patches):
            ...
            patches_map = patch.add_to_image(patches_map, patch)

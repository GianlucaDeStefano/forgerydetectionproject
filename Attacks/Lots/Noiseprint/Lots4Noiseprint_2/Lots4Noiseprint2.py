...
class LotsNoiseprint2_a(Lots4NoiseprintBase):
    ...
    def __init__(self, target_image:Picture, mask: np.array, image_path, mask_path, qf: int = None,
        ...
        super().__init__(target_image, mask, "LOTS4Noiseprint_2", image_path, mask_path, qf, patch_size, steps,
    ...
    def _generate_target_representation(self):
        ...
        image = self.original_image.to_float().one_channel
        ...
        authentic_patches = original_noiseprint.get_authentic_patches(self.mask, self.patch_size, force_shape= True)

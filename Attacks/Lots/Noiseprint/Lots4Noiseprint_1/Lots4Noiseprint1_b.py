...
class LotsNoiseprint1_b(Lots4NoiseprintBase):
    ...
    def __init__(self, target_image: np.array, mask: np.array, image_path, mask_path, qf: int = None,
        ...
        self.adversarial_noise = np.zeros((self.attacked_image.shape[0], self.attacked_image.shape[1]))
    ...
    def _attack_step(self):
        ...
        # add this iteration's contribution to the image
        self.attacked_image = (self.attacked_image - one_2_three_channel(image_gradient)).clip(0,1).astype(np.float32)

...
configs = Configs("../config.yaml", "Noiseprint-Columbia")
...
experiment =  NoiseprintExperiment(attack,dataset,possible_forgery_masks,configs.create_debug_folder("outputs"),False)
